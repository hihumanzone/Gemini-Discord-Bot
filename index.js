...
const nevPrompt = "NSFW, rating_explicit, (deformed, distorted, disfigured:1.3), poorly drawn, bad anatomy, wrong anatomy, extra limb, missing limb, floating limbs, (mutated hands and fingers:1.4), disconnected limbs, mutation, mutated, ugly, disgusting, blurry, amputation";
const activities = [
...
function generateWithSDXLAlt(prompt, resolution) {
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      const dataFirstRequest = {
        "data": [prompt, nevPrompt, randomDigit, true, width, height, 3, 10],
        "event_data": null,
        "fn_index": 1,
        "trigger_id": 5,
        "session_hash": session_hash
