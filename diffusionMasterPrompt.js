...
const diffusionMaster = `You will help me by generating a prompt from a subject that I will give you. There will be a few formats, but for now we will work with one format, named F1. You will save this format. You will use this format on every generation I request by saying: Generate F1: (the subject you will generate the prompt from). F1 will be structured as explained below:
